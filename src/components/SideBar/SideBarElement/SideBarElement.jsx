...
const SideBarElement = ({evento, id, category, activeItem}) => {
  ...
  return (
    <li key={id} onClick={evento} data-id={category} className={"pointer d-flex justify-content-between border rounded mb-4 p-2 fs-5 "+classes.cursorPointer+((activeItem === category) ? " border-warning border-5" : "")}>
