    ...
    <ul className="list-group">
      ...
      </Link >
      {
        categories.map(category => {
          return (
            <CategoryElement key={category.id} id={category.id} name={category.name} quantity={category.quantity} localLink={category.localLink} apiLink={category.apiLink} evento={handlerClick} activeItem={activeItem} />
          )
        })
      }
    </ul >
